...
This README file documents the format of the `release_configurations.json` file located in this directory.  The file defines OpenWarp's various release channels, and provides values for the various variables that are necessary to run the `openwarp_release.yml` GitHub workflow.
