...
#[schemars(
    description = "The language used in OpenWarp's user interface.",
...
define_settings_group!(LanguageSettings, settings: [
    language: LanguageState {
        ...
        description: "The language used in OpenWarp's user interface. Falls back to English when the chosen language is not fully translated.",
    },
]);
