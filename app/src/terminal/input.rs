...
/// Renders a [`PromptChipShellCommand`] into a concrete shell command string,
/// quoting every interpolated argument for the given shell so chip values
/// (branch names, directories, node versions) can't inject shell syntax.
