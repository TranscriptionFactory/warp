...
const REPO_URL: &str = "https://github.com/TranscriptionFactory/warp";
const CONTRIBUTING_URL: &str = "https://github.com/TranscriptionFactory/warp/blob/main/CONTRIBUTING.md";
